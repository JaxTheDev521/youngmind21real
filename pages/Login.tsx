...
const Login: React.FC<LoginProps> = ({ onLogin }) => {
  ...
  return (
    <div className="min-h-screen bg-neutral-light flex items-center justify-center px-4 relative overflow-hidden">
      ...
      <div className="max-w-md w-full glass rounded-[3rem] shadow-2xl overflow-hidden border-white/50 animate-fade-in relative z-10 hover:shadow-orange-glow/10 transition-all duration-500">
        <div className="bg-hero-gradient p-10 text-white text-center relative overflow-hidden">
          ...
          <h2 className="text-4xl font-black font-lexend relative z-10 tracking-tight uppercase">Citizen Portal</h2>
          <p className="text-white/80 mt-3 text-lg font-medium relative z-10 italic">Enter your digital world</p>
        </div>
        <form onSubmit={handleSubmit} className="p-10 space-y-8">
          ...
          <button type="submit" className="w-full py-5 bg-primary-orange text-white rounded-2xl font-black text-lg hover:bg-highlight-yellow hover:text-midnight transition-all shadow-2xl shadow-orange-glow active:scale-95 uppercase tracking-wide">
            Access Dashboard 🚀
          </button>
        </form>
      </div>
