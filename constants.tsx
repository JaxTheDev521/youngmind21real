...
export const DEPARTMENTS: Department[] = [
  { id: '1', name: 'Commerce & Trade', description: 'Mastering the marketplace and entrepreneurship.', color: 'bg-emerald-500', icon: '💰' },
  { id: '2', name: 'Justice & Ethics', description: 'Upholding values and resolving conflicts.', color: 'bg-midnight', icon: '⚖️' },
  { id: '3', name: 'Innovation & Tech', description: 'Building the future with digital skills.', color: 'bg-cyan', icon: '🚀' },
  { id: '4', name: 'Arts & Culture', description: 'Creative expression and community building.', color: 'bg-coral', icon: '🎨' },
];
